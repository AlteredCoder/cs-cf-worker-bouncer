module crowdsec-cf-worker-bouncer

go 1.20

replace github.com/crowdsecurity/crowdsec-cf-worker-bouncer => ./

require (
	github.com/crowdsecurity/crowdsec-cf-worker-bouncer v0.0.0-00010101000000-000000000000
